...
export const LEFT_PANNEL_WIDTH_EXPANDED = ELEMENT_LONG_IMAGE_SIZE * 4 + BORDER_WIDTH_CATEGORY_SELECTOR * 2;
export const LEFT_PANNEL_WIDTH_COLLAPSED = ELEMENT_LONG_IMAGE_SIZE + BORDER_WIDTH_CATEGORY_SELECTOR * 2;

export const BUILD_CARD_WIDTH = 220;

export const MAX_WIDTH_IN_BUILD_CARD = BUILD_CARD_WIDTH - PADDING_BUILD_CARD * 2; // 200
