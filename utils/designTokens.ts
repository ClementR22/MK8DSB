...
export const BORDER_RADIUS_CATEGORY_SELECTOR = 8; // au lieu de BORDER_RADIUS_STANDARD - PADDING_PANNEL_PAGINATED; // = 6
...
export const ELEMENT_PICKER_LIST_IMAGE_SIZE = 60;
export const ELEMENT_PICKER_LIST_IMAGE_RATIO = 1.1;

// Largeurs définies pour la colonne de gauche
export const LEFT_PANNEL_WIDTH_EXPANDED = ELEMENT_PICKER_LIST_IMAGE_SIZE * 4 + BORDER_WIDTH_CATEGORY_SELECTOR * 2;
export const LEFT_PANNEL_WIDTH_COLLAPSED = ELEMENT_PICKER_LIST_IMAGE_SIZE + BORDER_WIDTH_CATEGORY_SELECTOR * 2;
