// elementsSelector/selector/CategorySelectorCollapsed.tsx
...
interface CategorySelectorCollapsedProps {
  ...
  onPress: () => void; // This is the expand action
}

const CategorySelectorCollapsed: React.FC<CategorySelectorCollapsedProps> = ({ selectedCategory, onPress }) => {
